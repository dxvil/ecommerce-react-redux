...
const Shoe = ({title, price, img}) => {
    ...
    useEffect(() => {
        ...
        refContainer.current.addEventListener('mouseenter', (e) => {
            const card = refProduct.current;
        ...
        refContainer.current.addEventListener('mouseleave', (e) => {
            const card = refProduct.current;
  ...
  return (
      <div ref={refContainer} className="container-product">
        <div ref={refProduct} key={title} className="product">
          ...
          <p ref={refTitle} className="shoe-title">{title}</p>
          <p ref={refPrice} className="shoe-price">{price}</p>
        </div>
      </div>
  );
};
